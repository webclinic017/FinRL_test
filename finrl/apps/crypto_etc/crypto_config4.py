...
RESULTS_DIR = f"results_4"
TOTAL_TIMESTAMPS = 80000
# os.makedirs(TRAINED_MODEL_DIR)


## time_fmt = '%Y-%m-%d'
ENUMERATE_START_DATE = "2020-12-01"
ENUMERATE_END_DATE = "2021-06-01"

ENUMERATE_START_TRADE_DATE = "2021-05-01"
ENUMERATE_FUTURE_MONTH = 1
ENUMERATE_ROLLING_DAYS = 10
MODEL_TYPE = 'ddpg'
...
TECHNICAL_INDICATORS_LIST = [
    "macd",   "macds",  "macdh",
    "rsi_30", "rsi_20", "rsi_10",
    "cci_30", "cci_20", "cci_10",
    "dx_30",  "dx_20",  "dx_10",
    "pdi_30", "pdi_20", "pdi_10",
    "mdi_30", "mdi_20", "mdi_10",
    "vr_30_sma", "vr_20_sma", "vr_10_sma",
    "wr_30",  "wr_20",  "wr_10",
]
